...
- (id) initWithFrame:(CGRect)frame captureSession:(AVCaptureSession *)captureSession
{
    ...
    if ( self ) {
        ...
        NSLog(@"PREVIEW LAYER SIZE IS: %@", _previewLayer);
    }
...
- (UIView *) topContainerBar
{
    if ( !_topContainerBar ) {
        ...
        // set top bar color on main camera view
        [_topContainerBar setBackgroundColor:[UIColor colorWithRed:99.0/255.0 green:99.0/255.0 blue:99.0/255.0 alpha:0.3]];
    }
...
- (UIView *) bottomContainerBar
{
    if ( !_bottomContainerBar ) {
        ...
        _bottomContainerBar = [[UIView alloc] initWithFrame:(CGRect){ 0, newY, CGRectGetWidth(self.bounds), CGRectGetHeight(self.bounds) - newY - 50 }];
        [_bottomContainerBar setUserInteractionEnabled:YES];
        // WHITE COLOR
        [_bottomContainerBar setBackgroundColor:[UIColor colorWithWhite:1 alpha:0]];
    }
...
- (UIButton *) photoLibraryButton
{
    if ( !_photoLibraryButton ) {
        ...
        [_photoLibraryButton setFrame:(CGRect){ 25, CGRectGetMidY(self.bottomContainerBar.bounds) - 15, 44, 44 }];
...
- (UIButton *) closeButton
{
    if ( !_closeButton ) {
        ...
        [_closeButton setFrame:(CGRect){ CGRectGetWidth(self.bounds) - 59,  20, 30, 30 }];
...
- (UIButton *) cameraButton
{
    if ( !_cameraButton ) {
        ...
        [_cameraButton setImage:[[UIImage imageNamed:@"flip"] tintImageWithColor:[UIColor colorWithRed:32.f/255.f green:113/255.f blue:208.f/255.f alpha:1]] forState:UIControlStateSelected];
        [_cameraButton setFrame:(CGRect){ CGRectGetWidth(self.bounds) - 59, 0, 30, 30 }];
...
- (UIButton *) flashButton
{
    if ( !_flashButton ) {
        ...
        [_flashButton setImage:[[UIImage imageNamed:@"flash"] tintImageWithColor:[UIColor colorWithRed:32.f/255.f green:113/255.f blue:208.f/255.f alpha:1]] forState:UIControlStateSelected];
        [_flashButton setFrame:(CGRect){ 25, 17.5f, 30, 30 }];
...
- (UIButton *) gridButton
{
    if ( !_gridButton ) {
        ...
        [_gridButton setImage:[[UIImage imageNamed:@"cameraGrid"] tintImageWithColor:[UIColor colorWithRed:32.f/255.f green:113/255.f blue:208.f/255.f alpha:1]] forState:UIControlStateSelected];
...
- (CALayer *) exposeBox
{
    if ( !_exposeBox ) {
        ...
        [_exposeBox setBorderColor:[[UIColor colorWithRed:32.f/255.f green:113/255.f blue:208.f/255.f alpha:1] CGColor]];

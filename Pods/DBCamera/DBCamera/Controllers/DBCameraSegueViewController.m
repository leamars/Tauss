...
- (DBCameraFiltersView *) filtersView
{
    if ( !_filtersView ) {
        ...
        [_filtersView setBackgroundColor:[UIColor colorWithWhite:1 alpha:0]];
    }
...
- (UIView *) navigationBar
{
    if ( !_navigationBar ) {
        ...
        [_navigationBar setBackgroundColor:[UIColor colorWithWhite:1 alpha:0]];
...
- (UIView *) bottomBar
{
    if ( !_bottomBar ) {
        ...
        // THIS DOESN'T DO ANYTHING... BECAUSE IT'S HIDDEN?
        [_bottomBar setBackgroundColor:[UIColor redColor]];
        ...
        if ( !_forceQuadCrop ) {
            ...
            // WELL, THIS CHANGES THE ASPECT RATION'S COLOR
